    ...
    <main class="admin-main container">
      ...
      <div class="admin-card">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <input id="admin-search" class="form-control" type="search" placeholder="Search" style="max-width: 240px;">
        </div>
        <div class="table-responsive">
          <table class="table admin-table align-middle mb-0" id="admin-products-table">
            <thead>
              <tr>
                <th>Name</th>
                <th>Category</th>
