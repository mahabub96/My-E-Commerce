    ...
    <section class="min-vh-100 d-flex align-items-center">
      <div class="container d-flex justify-content-center">
        <div class="promo-box" style="max-width: 520px; width: 100%;">
          ...
          <form class="mt-4" aria-label="Login form" method="post" action="/login">
            <input type="hidden" name="_token" value="<?= csrf_token() ?>">
            <div class="mb-3">
              <label class="form-label" for="loginEmail">Email</label>
              <input class="form-control" id="loginEmail" name="email" type="email" placeholder="you@example.com" required>
            </div>
            <div class="mb-3">
          ...
          <p class="text-center text-muted mt-3 mb-0">New here? <a href="/register">Create an account</a></p>
        </div>
      </div>
    </section>
  </main>
